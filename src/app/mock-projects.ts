...
export const PROJECTS: Project[] = [
...

  {
    ...
    duration: '1year July 2020 to October 2021',
    overviewText: 'During my formation at teh WildCodeSchool, with my team, we have the mission to create the B2B website of the Belgium brand Sixitiens. ',
    subTitle1: 'The demand of the client',
    subTitle1Text: 'Creaye a B2B website to allow to manage the sales & customers',
    subTitle2: 'The solution',
    subTitle2Text: 'The solution was to create an Angular platforme with an authotification system.',
  ...
  },
  {
    ...
    toolsSkills: ['UX/UI skills',
      ...
      'Agile (scrum) environement',],
    myPosition: 'Junior front-end developer in a team of junior front-end ',
    duration: '6 months formation of Full Stack Developer at WildeCodeSchool ',
